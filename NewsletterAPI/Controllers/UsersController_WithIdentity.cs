...
namespace NewsletterAPI.Controllers
{
    ...
    public class UsersController_WithIdentity : Controller
    {
        private readonly SignInManager<IdentityUser> _signInManager;
        private readonly UserManager<IdentityUser> _userManager;
        private readonly ILoggerService _logger;
        private readonly IConfiguration _config;
        public UsersController_WithIdentity(SignInManager<IdentityUser> signInManager,
        ...
        [AllowAnonymous]
        [HttpPost]
        public async Task<IActionResult> Login([FromBody] UserDTO userDTOs)
        {
            var location = GetControllerActionNames();
            try
            {
                var username = userDTOs.EmailAddress;
                var password = userDTOs.Password;
