...
namespace NewsletterAPI.Migrations
{
    ...
    [Migration("20231217085435_addUserTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsletterAPI.Data.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NewsletterAPI.Data.Models.SendNewsletterLog", b =>
                {
                    b.HasOne("NewsletterAPI.Data.Models.Newsletter", null)
                        .WithMany("SendNewsletterLogs")
                        .HasForeignKey("NewsletterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NewsletterAPI.Data.Models.Personnel", null)
                        .WithMany("SendNewsletterLogs")
            ...
            modelBuilder.Entity("NewsletterAPI.Data.Models.Newsletter", b =>
                {
                    b.Navigation("SendNewsletterLogs");
                });
